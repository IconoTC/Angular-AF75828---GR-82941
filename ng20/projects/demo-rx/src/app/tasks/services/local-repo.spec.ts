...
fdescribe('LocalRepo', () => {
  let service: LocalRepo;

  beforeEach(() => {
    spyOn(window.localStorage, 'getItem'); // Suppress localStorage access
    spyOn(window.localStorage, 'setItem');  // Suppress localStorage access
    ...
    service = TestBed.inject(LocalRepo);
    service['_data'] = [
